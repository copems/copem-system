        ...
        <div class="permit-form-wrapper">
          <div id="civil-structural-permit-form-page-1">
            <div class="header-section">
              ...
              <div class="form-no" style="visibility: hidden">NBC FORM NO. A - 02</div>
            </div>
            ...
            <div class="box-container mt-2">
              ...
              <div class="box-content">
                <div class="pa-3">
                  <p class="section-title mb-2">NATURE OF CIVIL/STRUCTURAL WORKS:</p>
                  <div class="civil-works-grid">
                    <div class="civil-works-col">
                      <v-checkbox dense hide-details label="STAKING"></v-checkbox>
                      <v-checkbox dense hide-details label="EXCAVATION"></v-checkbox>
                      <v-checkbox dense hide-details label="SOIL STABILIZATION"></v-checkbox>
                      <v-checkbox dense hide-details label="PILING WORKS"></v-checkbox>
                      <v-checkbox dense hide-details label="FOUNDATION"></v-checkbox>
                    </div>
                    <div class="civil-works-col">
                      <v-checkbox dense hide-details label="ERECTION/LIFTING"></v-checkbox>
                      <v-checkbox dense hide-details label="CONCRETE FRAMING"></v-checkbox>
                      <v-checkbox dense hide-details label="STRUCTURAL STEEL FRAMING"></v-checkbox>
                      <v-checkbox dense hide-details label="SLABS"></v-checkbox>
                      <v-checkbox dense hide-details label="WALLS"></v-checkbox>
                    </div>
                    <div class="civil-works-col">
                      <v-checkbox dense hide-details label="PRESTRESS WORKS"></v-checkbox>
                      <v-checkbox dense hide-details label="MATERIAL TESTING"></v-checkbox>
                      <v-checkbox dense hide-details label="STEEL TOWERS"></v-checkbox>
                      <v-checkbox dense hide-details label="TANKS"></v-checkbox>
                      <div class="scope-item">
                        <v-checkbox dense hide-details label="OTHERS (Specify)"></v-checkbox>
                        <span class="underline" style="flex-grow: 1; margin-left: 4px"></span>
                      </div>
                    </div>
                  </div>
            ...
            <div class="box-3-4-wrapper mt-2">
              <div class="info-box-wrapper">
                ...
                <div class="info-box">
                  ...
                  <div class="signature-caption-area">
                    <p class="font-weight-bold mb-0">CIVIL/STRUCTURAL ENGINEER</p>
              ...
              <div class="info-box-wrapper">
                ...
                <div class="info-box">
                  <p class="info-box-title">SUPERVISOR / IN-CHARGE OF CIVIL/STRUCTURAL WORKS</p>
                  <div class="signature-area">
                    <div class="signature-line-main"></div>
                    <div class="signature-line-date">Date</div>
                  </div>
          ...
          <div id="civil-structural-permit-form-page-2" class="page-break">
            ...
            <div class="box-7-container">
              ...
              <div class="architectural-documents-section">
                <p class="documents-title">FIVE (5) SETS OF CIVIL/STRUCTURAL DOCUMENTS</p>
                <div class="documents-grid">
                  <div class="documents-col">
                    ...
                    ></v-checkbox>
                    <v-checkbox dense hide-details label="2. BILL OF MATERIALS "></v-checkbox>
                  </div>
                  <div class="documents-col">
                    <v-checkbox dense hide-details label="6. COST ESTIMATES"></v-checkbox>

                    <div class="other-docs-item">
                      <v-checkbox dense hide-details label="9. OTHERS (Specify)"></v-checkbox>
            ...
            <div class="box-9-container">
              ...
              <ol class="conditions-list">
                <li>
                  ...
                  engineer/architect who drew up the plans and specifications for the
                  building/structure is responsible for damages if within fifteen (15) years from
                  the completion of the building/structure, the same should collapse due to defect
                  in the plans or specifications or defects in the ground. The engineer or architect
                  who supervises the construction shall be solidarily liable with the contractor
                  should the edifice collapse due to defect in the construction or the use of
                  inferior materials.
                </li>
                <li>
                  That the proposed civil/structural works shall be in accordance with the
                  structural plans filed with this Office and in conformity with the latest
                  Structural Code of the Philippines, the National Building Code and its IRR.
                </li>
                <li>
                ...
                <li>
                  ...
                  the civil/structural works conform to the provision of the Structural Code, the
