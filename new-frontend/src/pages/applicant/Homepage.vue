      ...
      <div class="services-grid">
        ...
        >
          ...
          <div class="service-body">
            ...
            <button
              class="apply-now-btn"
              @click="handleApplyNow(service.title)"
            >
              Apply Now
            </button>
          </div>
    ...
    <footer class="footer">
      <div class="footer-main">
        <div class="footer-col">
          ...
          <p class="footer-desc">
            The Construction Permit Management System is dedicated to providing
            efficient and transparent permit services to support safe and
            compliant construction in our community.
          </p>
        </div>
        <div class="footer-col">
        ...
        <div class="footer-col">
          ...
          <ul class="footer-contact">
            <li>
              <span class="footer-icon">📍</span> City Hall Building, Main
              Street, Philippines
            </li>
            <li><span class="footer-icon">📞</span> +63 (2) 1234-5678</li>
            <li>
              <span class="footer-icon">✉️</span> permits@construction.gov.ph
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="footer-bottom">
        © 2026 Construction Permit Management System. All rights reserved
        Builder
      </div>
    </footer>
  </div>
