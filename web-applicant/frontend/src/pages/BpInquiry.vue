    ...
    <v-container fluid class="pa-0 content-area">
      <v-row no-gutters class="fill-height">
        <v-col cols="12" class="pa-6 main-content-bg">
          ...
          >
            <div>
              ...
              <div class="processing-time-badge">
                <v-icon color="#23407c" size="20" class="mr-2"> mdi-clock-outline </v-icon>
          ...
          <v-card flat outlined color="#fff" class="mb-6 pa-4 timeline-card elevation-1">
          ...
          <v-card flat outlined color="#fff" class="mb-6 pa-4 requirements-card elevation-1">
            <div class="requirements-overview-card pa-0">
              ...
              <v-row>
                <v-col cols="12" md="4">
                  <div class="pa-2">
                    <div class="d-flex align-center mb-2">
                      ...
                      <span class="font-weight-bold text-green"> Basic Requirements </span>
                    </div>
                    <div
                ...
                <v-col cols="12" md="4">
                  <div class="pa-2">
                    <div class="d-flex align-center mb-2">
                      <v-icon color="red" size="20" class="mr-2"> mdi-alert-circle-outline </v-icon>
                      <span class="font-weight-bold text-red"> Common Reasons for Delays </span>
                    </div>
                    <div
                ...
                <v-col cols="12" md="4">
                  <div class="pa-2">
                    <div class="d-flex align-center mb-2">
                      ...
                      <span class="font-weight-bold text-orange"> Tips for Faster Processing </span>
                    </div>
                    <div
                      ...
                      class="d-flex align-center mb-1"
                    >
                      <v-icon color="orange" size="16" class="mr-1"> mdi-lightbulb </v-icon>
          ...
          >
            <div class="pa-0">
              <div class="d-flex align-center mb-4">
                <v-icon color="#2962ff" size="22" class="mr-2"> mdi-format-list-checks </v-icon>
              ...
              <v-row>
                <v-col cols="12" md="6" class="pt-0">
                  <v-expansion-panels flat accordion>
                    ...
                    >
                      <v-expansion-panel-title class="font-weight-bold text-blue-darken-3">
                        {{ category.title }}
                      </v-expansion-panel-title>
                      <v-expansion-panel-text>
                        <v-list dense class="pa-0">
                          <v-list-item v-for="(item, j) in category.items" :key="j" class="pl-2">
            ...
            <v-row>
              <v-col cols="12" md="6" class="pb-3">
                <v-card class="info-card pa-4" outlined>
                  <div class="d-flex align-center mb-2">
                    <v-icon color="#2962ff" size="24" class="mr-2"> mdi-clock-outline </v-icon>
              ...
              <v-col cols="12" md="6" class="pb-3">
                <v-card class="info-card pa-4" outlined>
                  <div class="d-flex align-center mb-2">
                    <v-icon color="#8e24aa" size="24" class="mr-2"> mdi-account-clock </v-icon>
              ...
              <v-col cols="12" md="6">
                <v-card class="info-card pa-4" outlined>
                  ...
                  <div class="info-content">
                    ...
                    <div class="text-caption">All fees must be settled before permit release</div>
                  </div>
                </v-card>
              </v-col>
              <v-col cols="12" md="6">
      ...
      timelineItems: [
        {
          ...
          description: 'Day 1 - Submit complete documents and initial verification',
        },
        {
          title: 'Document Review & Assessment',
          description: 'Days 2-3 - Thorough review of submitted documents and plans',
        },
        {
          title: 'Technical Evaluation',
          description: 'Days 4-5 - Engineering and architectural plan evaluation',
        },
        {
