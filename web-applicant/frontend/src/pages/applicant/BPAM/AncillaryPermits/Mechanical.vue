        ...
        <div class="permit-form-wrapper">
          <div id="mechanical-permit-form-page-1">
            <div class="header-section">
              ...
              <div class="form-no" style="visibility: hidden">NBC FORM NO. A - 04</div>
            </div>
            ...
            <div class="box-container mt-2">
              ...
              <div class="box-content">
                <div class="pa-3">
                  <p class="section-title mb-2">INSTALLATION AND OPERATION OF:</p>
                  <div class="mechanical-works-grid">
                    <div class="mechanical-works-col">
                      <v-checkbox dense hide-details label="BOILER"></v-checkbox>
                      <v-checkbox dense hide-details label="PRESSURE VESSEL"></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                    ...
                    <div class="mechanical-works-col">
                      <v-checkbox dense hide-details label="CENTRAL AIRCONDITIONING"></v-checkbox>
                      <v-checkbox dense hide-details label="MECHANICAL VENTILATION"></v-checkbox>
                      <v-checkbox dense hide-details label="ESCALATOR"></v-checkbox>
                      <v-checkbox dense hide-details label="MOVING SIDEWALK"></v-checkbox>
                      <v-checkbox dense hide-details label="FREIGHT ELEVATOR"></v-checkbox>
                      <v-checkbox dense hide-details label="PASSENGER ELEVATOR"></v-checkbox>
                      <v-checkbox dense hide-details label="CABLE CAR"></v-checkbox>
                    </div>
                    <div class="mechanical-works-col">
                      <v-checkbox dense hide-details label="DUMBWAITER"></v-checkbox>
                      <v-checkbox dense hide-details label="PUMPS"></v-checkbox>
                      <v-checkbox
                        dense
                        hide-details
                      ...
                      ></v-checkbox>
                      <v-checkbox dense hide-details label="FUNICULAR"></v-checkbox>
                    </div>
                  </div>
            ...
            <div class="box-3-4-wrapper mt-2">
              <div class="info-box-wrapper">
                ...
                <div class="info-box">
                  ...
                  <div class="signature-caption-area">
                    <p class="font-weight-bold mb-0">PROFESSIONAL MECHANICAL ENGINEER</p>
              ...
              <div class="info-box-wrapper">
                ...
                <div class="info-box">
                  <p class="info-box-title">SUPERVISOR / IN-CHARGE OF MECHANICAL WORKS</p>
                  <div class="designation-checkboxes">
                    ...
                    ></v-checkbox>
                    <v-checkbox dense hide-details label="MECHANICAL ENGINEER"></v-checkbox>
                  </div>
                  <div class="signature-area">
                    <div class="signature-line-main"></div>
                    <div class="signature-line-date">Date</div>
          ...
          <div id="mechanical-permit-form-page-2" class="page-break">
            ...
            <div class="box-7-container">
              ...
              <div class="architectural-documents-section">
                <p class="documents-title">FIVE (5) SETS OF MECHANICAL DOCUMENTS</p>
            ...
            <div class="box-9-container">
              ...
              <ol class="conditions-list">
                ...
                <li>
                  That the proposed mechanical works shall be in accordance with the mechanical
                  plans filed with this Office and in conformity with the latest Mechanical Code of
                ...
                <li>
                  ...
                  the mechanical works conform to the provision of the Mechanical Code, the National
