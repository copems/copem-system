            ...
            <v-window-item value="evaluation">
                ...
                <v-row no-gutters class="print-tight-row">
                  ...
                  <v-col cols="12" md="6" class="mb-2">
                    <span class="text-caption uppercase print-label"
                      >Address of Owner:</span
                    >
                    <span class="text-body-2 font-weight-bold ml-2">{{
                      inspectionData.ownerAddress
                    }}</span>
                  </v-col>
                  <v-col cols="12" md="6" class="mb-2">
                    <span class="text-caption uppercase print-label"
                      >Location of Installation:</span
                    >
                    <span class="text-body-2 font-weight-bold ml-2">{{
                      inspectionData.installationLocation
                    }}</span>
                  </v-col>
                  <v-col cols="12" md="6" class="mb-2">
                    <span class="text-caption uppercase print-label"
                      >Use or Character of Occupancy / No. of Storeys:</span
                    >
                    <span class="text-body-2 font-weight-bold ml-2">{{
                      inspectionData.occupancyCharacter
                    }}</span>
                  </v-col>
                </v-row>
              </div>
              ...
              <div class="print-section mt-6">
                <v-card class="rounded-lg border" flat>
                  ...
                  <v-card-text class="pa-4">
                    <v-textarea
                      v-model="inspectionData.comments"
                      variant="outlined"
                      rows="4"
              ...
              <div class="mt-8 border-t pt-4 print-mt-4">
                <div
                  class="d-flex justify-space-between align-center print-signature-block"
                >
                  <v-btn
                    color="primary"
