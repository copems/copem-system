<template>
  <div class="page-container px-6 pt-2 pb-6">
      ...
      <v-col cols="12" md="5" lg="4" class="pt-0">
        ...
        >
          <div class="pa-4 pb-1">
            ...
            >
              <v-btn
                ...
                :class="
                  activeTab === 'checklist' ? 'active-pill' : 'inactive-pill'
                "
              ...
              <v-btn
                ...
                class="flex-grow-1 text-none font-weight-bold transition-swing"
                :class="
                  activeTab === 'assessment' ? 'active-pill' : 'inactive-pill'
                "
            ...
            <v-window v-model="activeTab">
              ...
              <v-window-item value="assessment">
                ...
                <div class="mb-4">
                  ...
                  <div class="bg-blue-grey-lighten-5 pa-4 rounded-lg border">
                    ...
                    <div class="d-flex justify-space-between text-body-2 mb-2">
                      <span class="text-grey-darken-1">Processing Fee:</span>
                      <span class="font-weight-medium">{{
          ...
          <v-card-actions class="pa-4 bg-white d-flex align-center">
            <div class="text-caption font-weight-bold text-grey-darken-1 mr-2">
              Status:
            </div>
            <v-chip
              :color="statusColor"
